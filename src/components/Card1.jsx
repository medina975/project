...
function Card1({handleCardClick , item ,name, img, shades, price}) {
    const [currentShade, setCurrentShade] = useState(shades[0])
    const navigate = useNavigate()
    const {addToBasket, setBasketOpen} = useContext(rareContext)
    
    
  return (
    <>
    <div className='slide'>
        <div className="slide1" onClick={() => handleCardClick(item)} >
            <Link 
